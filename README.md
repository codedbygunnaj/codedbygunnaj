...
![DSA](https://img.shields.io/badge/DSA-Expertise-orange?style=for-the-badge)

**🧠 Machine Learning & GenAI**
![GenAI](https://img.shields.io/badge/Generative_AI-LLMs-blueviolet?style=for-the-badge)
...
**🛡️ CS Fundamentals & Systems**
![OS](https://img.shields.io/badge/Operating_Systems-Linux-FCC624?style=for-the-badge&logo=linux&logoColor=black)
![CN](https://img.shields.io/badge/Computer_Networks-0081CB?style=for-the-badge&logo=cisco&logoColor=white)
![Cybersecurity](https://img.shields.io/badge/Cybersecurity-🛡️-red?style=for-the-badge)
![OOPs](https://img.shields.io/badge/OOPs-Concepts-green?style=for-the-badge)

---

### 🔭 Current & Past Highlights
- 🛰️ **Minor 2:** Working on **Deforestation Detection** using Multispectral Satellite Images & U-Net (6th Sem).
- 🛡️ **Network Security:** Built a **Packet Sniffer** and **ARP Spoofing tool** using Python & Wireshark.
- 🚗 **Minor 1:** Developed **IDMAS** (Intelligent Driver Monitoring & Assistance System) with Python & MediaPipe.
- 🖥️ **Legacy Project:** Built a **CPU Scheduling Simulator** UI in C++ (Available on Gunaj0517).
- 📊 **Finance:** Experience with Financial Management concepts (WACC, Rate of Return).
